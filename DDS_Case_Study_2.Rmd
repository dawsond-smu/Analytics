...
head(CaseStudyNoSalaryNoAttrition)
summary(CaseStudyNoSalaryNoAttrition)
glimpse(CaseStudyNoSalaryNoAttrition)
skim(CaseStudyNoSalaryNoAttrition)
DataExplorer::create_report(CaseStudyNoSalaryNoAttrition)
```
